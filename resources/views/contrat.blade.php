        ...
        <div class="rounded overflow-hidden shadow-lg">
            ...
            <div class="px-6 py-4 mb-5">
              <div class="flex justify-between mb-5">
                ...
                <a href="{{route('add-suivi', ['id'=>$contrat->id])}}" class="bg-green-500 hover:bg-green-700 text-white font-bold py-3 px-4 rounded"><i class="fas fa-plus-circle"></i> Ajouter</a>
              </div>
